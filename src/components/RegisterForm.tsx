        ...
        {registerSuccess && (
          ...
          >
            ...
            <button
              ...
              className="mt-2 w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold transition-all shadow-md active:scale-[0.99] cursor-pointer"
            >
              Ir a Iniciar Sesión
            </button>
          </motion.div>
